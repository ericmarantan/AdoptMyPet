...
<div class="wrapper">
  ...
  @include('adopter.layout.header')

  @include('adopter.layout.sidebar')
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <a href="{{ url('adopter/logout')}}" class="nav-link"><i class="fas fa-sign-out-alt"></i> Logout</a>
  </aside>
  <!-- /.control-sidebar -->

  @include('adopter.layout.footer')
</div>
<!-- ./wrapper -->
...
<script src="{{ url('admin/js/adopter.js') }}"></script>
