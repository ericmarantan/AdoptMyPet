        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="post" action="{{ url('adopter/register-adopter') }}">@csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ Auth::guard('adopter')->user()->name }}" id="admin_name" name="admin_name">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ Auth::guard('adopter')->user()->company }}" id="admin_company" name="admin_company">

                    @if($errors->has('admin_company'))
                        <small style='color:red'><i class='fas fa-exclamation-circle'></i> <span>{{ $errors->first('admin_company') }}</span></small>
                    @endif
